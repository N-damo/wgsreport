...
class CNV(object):
                        ...
                        for sampleRecord in rec.samples.values():
                            ...
                            if CN == 2:
                                ...
                                if GT == (0, 0) or GT == (None, None):
                                    ...
                                    samples_sv[sampleRecord.name]['Chrom'].append(
                                        chrom)
                                    samples_sv[sampleRecord.name]['Start'].append(
                                        start)
                                    ...
                                    samples_sv[sampleRecord.name]['Type'].append(
                                        sv_type)
                                    samples_sv[sampleRecord.name]['CN'].append(
                                        CN)
    ...
    def cnv_plot(self, df, sample):
        ...
        plt.tight_layout()
        plt.savefig('{module}/{sample}/CNV_distribution.png'.format(
